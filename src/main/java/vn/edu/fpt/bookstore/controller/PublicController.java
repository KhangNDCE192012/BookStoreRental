...
public class PublicController {
    ...
    public String home(Model model) {
        model.addAttribute("books", bookService.search(null, null, null, null, null, 0, 8).getContent());
        model.addAttribute("categories", bookService.activeCategories());
        return "public/index";
    }
    ...
    public String books(@RequestParam(required = false) String keyword,
                        ...
                        Model model) {
        Page<Book> result = bookService.search(keyword, categoryId, author, minPrice, maxPrice, page, 12);
    ...
    public String detail(@PathVariable UUID id, Model model) {
        ...
        model.addAttribute("availableCopies", bookService.availableCopies(id));
